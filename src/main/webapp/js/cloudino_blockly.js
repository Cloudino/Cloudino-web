...
Blockly.resize = function()
{
    if (Blockly.fireUiEvent)
    {
...
Blockly.Blocks['cdino_setinterval'] = {
    init: function() {
        ...
        this.appendDummyInput()
                .setAlign(Blockly.ALIGN_RIGHT)
                .appendField("with")
                .appendField(new Blockly.FieldTextInput("timer"), "timer");
...
Blockly.Arduino['cdino_print'] = function(block) {
    ...
    Blockly.Arduino.addInclude("Cloudino", '#include<Cloudino.h>');
    Blockly.Arduino.addVariable("cdino", "Cloudino cdino;");
    Blockly.Arduino.addSetup("Cloudino", 'cdino.begin();');
...
Blockly.Arduino['cdino_on'] = function(block) {
    ...
    Blockly.Arduino.addFunction(text_name, 'void ' + text_name + '(String ' + text_msg + '){\n' + statements_name + '}');

    Blockly.Arduino.addSetup('cdino_' + text_name, 'cdino.on(' + value_topic + ',' + text_name + ');');
    Blockly.Arduino.addSetup("Cloudino", 'cdino.begin();');

    Blockly.Arduino.addLoop('loop_cdino', 'cdino.loop();');
    // TODO: Assemble Arduino into code variable.
    var code = '';
    return code;
};
...
Blockly.Arduino['cdino_setinterval'] = function(block) {
    var text_name = block.getFieldValue('name');
    var text_timer = block.getFieldValue('timer');
    ...
    Blockly.Arduino.addInclude("Cloudino", '#include<Cloudino.h>');
    Blockly.Arduino.addVariable("cdino", "Cloudino cdino;");
    Blockly.Arduino.addVariable(text_timer, "int "+text_timer+";");
    ...
    Blockly.Arduino.setups_['setup_cdino_' + text_name] = text_timer + '=cdino.setInterval(' + value_time + ',' + text_name + ');';
...
Blockly.Arduino['cdino_settimeout'] = function(block) {
    ...
    Blockly.Arduino.setups_['setup_cdino_' + text_name] = text_timer + '=cdino.setTimeout(' + value_time + ',' + text_name + ');';
...
Blockly.JavaScript['cdinojs_print'] = function(block) {
    ...
    Blockly.JavaScript.requires_["Cloudino"] = "require(\"Cloudino\");";
...
Blockly.JavaScript['io_digitalwrite'] = function(block) {
    ...
    var stateOutput = Blockly.JavaScript.valueToCode(block, 'STATE', Blockly.JavaScript.ORDER_ATOMIC) || 'LOW';

    //Blockly.JavaScript.reservePin(block, pin, Blockly.JavaScript.PinTypes.OUTPUT, 'Digital Write');      

    Blockly.JavaScript.requires_['GPIO'] = "require(\"GPIO\");";
    Blockly.JavaScript.definitions_['setup_output_' + pin] = 'pinMode(' + pin + ', OUTPUT);';
...
Blockly.JavaScript['io_analogwrite'] = function(block) {
    ...
    var stateOutput = Blockly.JavaScript.valueToCode(block, 'NUM', Blockly.JavaScript.ORDER_ATOMIC) || '0';

    //Blockly.JavaScript.reservePin(block, pin, Blockly.JavaScript.PinTypes.OUTPUT, 'Analogue Write');
...
Blockly.JavaScript['io_pulsein'] = function(block) {
    ...
    //Blockly.JavaScript.reservePin(block, pin, Blockly.JavaScript.PinTypes.INPUT, 'Pulse Pin');
...
Blockly.JavaScript['cdinojs_setinterval'] = function(block) {
    ...
    var statements_name = Blockly.JavaScript.statementToCode(block, 'NAME');
    Blockly.JavaScript.requires_['Timer'] = "require(\"Timer\");";
...
Blockly.JavaScript['text_indexOf'] = function(block) {
    ...
    Blockly.JavaScript.requires_['String'] = "require(\"String\");";
