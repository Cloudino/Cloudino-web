...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Add Device Group</li>
    </ol>
</section>
    ...
    <div class="row">
        <div class="col-md-8">
            ...
            <div class="box box-primary">
                ...
                <!-- form start -->
                <form class="form-horizontal" data-target=".content-wrapper" data-submit="ajax" action="addDeviceGroup" role="form">
                    <div class="box-body">
