...
<%
    ...
    if (name != null) {
        ...
        if (ret != null) {
            response.sendRedirect("cloudRuleDetail?ID=" + obj.getNumId()+"&_rm=true");
            return;
        } else {
...
<section class="content-header">
    <h1>Cloud Rule<small> <%=name%></small></h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Panel</a></li>
        <li><a href="#">Cloud Rule</a></li>
        ...
        <div class="col-md-12" id="main_content">
            ...
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    ...
                    <li class=""><a href="#tab_2" data-toggle="tab" aria-expanded="false">Rule</a></li>
                </ul>
                <div class="tab-content">
                    <div class="tab-pane active" id="tab_1">

                        <form class="form-horizontal" data-target=".content-wrapper" data-submit="ajax" action="cloudRuleDetail" role="form">
                            <div class="box-body">
                        ...
                        <script type="text/javascript">
                            function removeObj(alink){
                                    if(confirm('Are you sure to remove this Cloud Rule?')){
                                        var urlRemove = 'cloudRuleDetail?ID=<%=id%>&act=remove';
