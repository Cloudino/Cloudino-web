...
Blockly.Arduino.finish = function(code) {
  ...
  var includes = [], definitions = [], variables = [], functions = [], loops= [];
 ...
 * @return {!boolean} Indicates if the new setup code overwrote a previous one.
 */
Blockly.Arduino.addLoop = function(setupTag, code, overwrite) {
  var overwritten = false;
  if (overwrite || (Blockly.Arduino.loops_[setupTag] === undefined)) {
    Blockly.Arduino.loops_[setupTag] = code;
    overwritten = true;
  }
  return overwritten;
};
